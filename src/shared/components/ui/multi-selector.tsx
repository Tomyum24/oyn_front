...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "border-input bg-background flex flex-wrap gap-1 rounded-lg border p-1 py-2",
        {
      ...
      {value.map((item, index) => (
        <Badge
          ...
          className={cn(
            ...
            activeIndex === index && "border-muted-foreground border-2",
          )}
          variant="secondary"
        >
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <CommandPrimitive.Input
      ...
      className={cn(
        "placeholder:text-muted-foreground ml-1 flex-1 bg-transparent text-sm outline-none",
        className,
