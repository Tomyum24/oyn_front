...
interface DateRangePickerProps {
  ...
  showCompare?: boolean;
  /** Option for showing type date */
  setTypeDate?: (typeDate: string) => void;
  // className for the date range picker
  className?: string;
}

const formatDate = (date: Date, locale: string = "ru"): string => {
...
const PRESETS: Preset[] = [
  ...
  { name: "last7", label: "Последние 7 дней" },
  { name: "last14", label: "Последние 14 дней" },
  ...
  { name: "lastMonth", label: "Прошлый месяц" },
];
...
export const DateRangePicker: FC<DateRangePickerProps> = ({
  ...
  return (
    ...
    >
      <PopoverTrigger className={cn("w-full md:w-fit", className)}>
        <Button variant="outline" className={cn("w-full md:w-fit", className)}>
                ...
                {showCompare && (
                  <div className="flex items-center space-x-2 py-1 pr-4">
                    <Switch
                      ...
                      id="compare-mode"
                    />
                    <Label htmlFor="compare-mode">Сравнить</Label>
                  </div>
                )}
